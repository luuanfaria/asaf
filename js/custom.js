 ...
 */
    ...
    $("#atendimentoForm").on('submit', function (e) {
        ...
        if (isValidEmail(data['email']) && (data['message'].length > 1) && (data['name'].length > 1) && (data['subject'].length > 1)) {
            $.ajax({
                ...
                data: data,
                success: function () {
                    $('#atendimentoForm .input-success').delay(500).fadeIn(1000);
                    $('#atendimentoForm .input-error').fadeOut(500);
                }
            });
        } else {
            $('#atendimentoForm .input-error').delay(500).fadeIn(1000);
            $('#atendimentoForm .input-success').fadeOut(500);
        }
    ...
    $("#contactForm").on('submit', function (e) {
        ...
        if (isValidEmail(data['email']) && (data['name'].length > 1) && (data['cpf'].length > 1)) {
            $.ajax({
                type: "POST",
                url: "sendmail.php",
                data: data,
